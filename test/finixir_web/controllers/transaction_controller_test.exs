defmodule FinixirWeb.TransactionControllerTest do
  ...
  @create_attrs %{
    amount: 120.5,
    transaction_date: ~D[2010-04-17]
  }
  @update_attrs %{
    amount: 456.7,
    transaction_date: ~D[2011-05-18]
  }
  @invalid_attrs %{amount: nil, transaction_date: nil}

  def fixture(:transaction) do
    {:ok, transaction} = Aggregation.create_transaction(@create_attrs)
    transaction
  end
